...
-(void)saveUserStocklist:(Company*)companyToSave{
    ...
    NSManagedObjectContext *context = [self managedObjectContext];
    NSManagedObject *stocks = [NSEntityDescription
                               insertNewObjectForEntityForName:@"User" inManagedObjectContext:context];
    [stocks setValue:companyToSave.toDict forKey:@"stocks"];
    
    NSError *error;
    if([context save:&error]){
        [_userWatchList addObject:companyToSave.toDict];
        NSLog(@"Saved!");
    } else {
        NSLog(@"Not Saved!");
    }
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "Dellybro.cored" in the application's documents directory.
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"cored.sqlite"];
    NSError *error = nil;
